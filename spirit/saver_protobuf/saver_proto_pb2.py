...
_FIELD_FIELDVALUE = _descriptor.Descriptor(
  name='FieldValue',
  full_name='Field.FieldValue',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='value_type', full_name='Field.FieldValue.value_type', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='int_value', full_name='Field.FieldValue.int_value', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='string_value', full_name='Field.FieldValue.string_value', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='double_value', full_name='Field.FieldValue.double_value', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='sub_fields_value', full_name='Field.FieldValue.sub_fields_value', index=4,
...
_FIELD = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='field_name', full_name='Field.field_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='field_value', full_name='Field.field_value', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  nested_types=[_FIELD_FIELDVALUE, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_FIELD_FIELDVALUE.fields_by_name['sub_fields_value'].message_type = _FIELD
_FIELD_FIELDVALUE.containing_type = _FIELD
_FIELD.fields_by_name['field_value'].message_type = _FIELD_FIELDVALUE
_RESULT.fields_by_name['parser_fields'].message_type = _FIELD
...
Field = _reflection.GeneratedProtocolMessageType('Field', (_message.Message,), {
  ...
  'FieldValue' : _reflection.GeneratedProtocolMessageType('FieldValue', (_message.Message,), {
    'DESCRIPTOR' : _FIELD_FIELDVALUE,
    '__module__' : 'saver_proto_pb2'
    # @@protoc_insertion_point(class_scope:Field.FieldValue)
    })
  ,
  'DESCRIPTOR' : _FIELD,
  '__module__' : 'saver_proto_pb2'
...
_sym_db.RegisterMessage(Field.FieldValue)
